...
[ApiController]
public class BidsControllerV2 : ControllerBase
{
    private readonly IBidServiceV2 _bidService;

    public BidsControllerV2(IBidServiceV2 bidService)
    {
        _bidService = bidService;
    }

    [HttpGet]
    public async Task<ActionResult<IEnumerable<BidResultV2>>> GetAllBids()
    {
